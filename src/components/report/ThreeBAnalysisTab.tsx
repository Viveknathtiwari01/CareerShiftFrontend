      ...
      tasks: [
        {
          ...
          reason: "Requires deep context, strategic foresight, and cross-system understanding.",
          auto: "10%",
          tools: "Claude (for brainstorming)",
          importance: "High",
        },
        {
          name: "Complex Debugging",
          reason: "Requires intuition and tracing across unmapped legacy systems.",
          auto: "20%",
          tools: "Cursor (for context mapping)",
          importance: "High",
        },
      ],
    },
      ...
      tasks: [
        {
          ...
          reason: "Standardized patterns that LLMs excel at generating instantly.",
          auto: "95%",
          tools: "GitHub Copilot",
          importance: "Low",
        },
        {
          name: "Initial Log Parsing",
          reason: "Pattern recognition in text is a native strength of AI models.",
          auto: "85%",
          tools: "ChatGPT Advanced Data Analysis",
          importance: "Medium",
        },
      ],
    },
      ...
      tasks: [
        {
          ...
          reason:
            "AI can catch syntax and basic logic errors, but human needs to review business logic.",
          auto: "60%",
        ...
        },
        {
          ...
          reason: "AI drafts perfectly, human reviews for nuance and tone.",
          auto: "80%",
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          >
            <div
              className={`mx-auto w-12 h-12 rounded-full ${item.bg} flex items-center justify-center mb-3`}
            >
              ...
              {section.tasks.map((task, idx) => (
                <div key={idx} className="p-6 grid lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-1">
                    ...
                    <span
                      className={`inline-block px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest rounded-md ${section.bg} ${section.color}`}
                    >
