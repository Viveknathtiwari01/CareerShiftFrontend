    ...
    <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-muted-foreground leading-relaxed max-w-xs">
                You are ahead of many professionals in AI adoption, but there are opportunities to
                strengthen your leadership and strategic automation.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="rounded-3xl border border-border bg-background p-6 shadow-sm">
          ...
          <div className="space-y-4">
            {["Prompt Engineering", "AI Workflow Automation", "Strategic Leadership"].map(
              (item, idx) => (
                <div key={idx} className="flex items-center gap-3">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="rounded-3xl border border-primary/20 bg-primary/5 p-6 shadow-sm">
          ...
          <p className="text-sm font-medium text-muted-foreground">
            Routine tasks are increasingly AI-assisted.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-brand/20 bg-brand/5 p-6 shadow-sm">
          ...
          <p className="text-sm font-medium text-muted-foreground">
            Backend + AI positions you very well.
          </p>
        </div>
      ...
      <div className="rounded-3xl border border-border bg-background p-8 shadow-sm">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={idx}
              className="flex flex-col gap-2 rounded-2xl border border-border bg-muted/30 p-4"
            >
              <div className="h-6 w-6 rounded-full bg-brand/10 text-brand flex items-center justify-center font-bold text-xs">
                {idx + 1}
              </div>
