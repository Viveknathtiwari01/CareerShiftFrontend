  ...
  const sections = [
    {
      ...
      items: [
        {
          text: "Use AI daily for architecture documentation",
          priority: "High",
          impact: "High",
          time: "2h/wk",
          diff: "Low",
        ...
        {
          text: "Treat AI as a pair programmer for complex systems design",
          priority: "High",
    ...
    },
    {
      ...
      items: [
        {
          text: "Writing boilerplate code manually",
          priority: "High",
          impact: "Medium",
          time: "Instant",
          diff: "Low",
        ...
        {
          text: "Spending hours on initial log analysis without AI",
          priority: "Medium",
          impact: "High",
          time: "Instant",
          diff: "Low",
    ...
    },
    {
      ...
      items: [
        {
          text: "Unit test generation & initial PR descriptions",
          priority: "High",
          impact: "High",
          time: "3h/wk saved",
          diff: "Medium",
        ...
        {
          text: "Tagging and summarizing incoming bug reports",
          priority: "Medium",
          impact: "Medium",
          time: "2h/wk saved",
          diff: "High",
    ...
    },
    {
      ...
      items: [
        {
          text: "Advanced Prompt Engineering (Chain of Thought)",
          priority: "High",
          impact: "Transformational",
          time: "10h",
          diff: "Medium",
        ...
        {
          text: "Build prototype using LangChain or LlamaIndex",
          priority: "High",
          impact: "High",
          time: "20h",
          diff: "High",
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid md:grid-cols-2 gap-8">
        {sections.map((sec, sIdx) => (
          ...
          >
            <div
              className={`absolute -right-10 -top-10 h-32 w-32 rounded-full blur-3xl ${sec.bg}`}
            />
                ...
                <div key={idx} className="rounded-2xl border border-border bg-muted/30 p-5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-semibold">
                    ...
                    <div>
                      ...
                      <span className={DIFF_COLORS[item.diff] || "text-muted-foreground"}>
                        {item.diff}
                      </span>
                    </div>
                  </div>
