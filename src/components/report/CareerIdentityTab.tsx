          ...
          {[
            {
              ...
              reason: "Leverages deep backend skills while integrating AI natively.",
            },
            {
              role: "Platform Engineer",
              reason: "Fits strong architectural thinking and tooling focus.",
            },
            {
              role: "Solutions Architect",
              reason: "Natural progression for system design strengths.",
            },
          ].map((role) => (
            <div
              key={role.role}
