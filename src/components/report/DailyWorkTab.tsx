        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          >
            ...
            <div className="text-5xl font-display font-black text-foreground">
              40<span className="text-2xl text-muted-foreground">h</span>
            </div>
            <p className="text-sm text-muted-foreground mt-3 font-medium">
              Based on your reported tasks, you spend the majority of your time on deep technical
              work.
            </p>
          </motion.div>
        </div>
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs font-bold">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className={CRITICALITY_COLORS[task.criticality] || "text-muted-foreground"}>
                    {task.criticality}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  ...
                  <span className={AI_USAGE_COLORS[task.ai] || "text-muted-foreground"}>
                    {task.ai}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
