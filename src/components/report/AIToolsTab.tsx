  ...
  const categories = [
    {
      ...
      tools: [
        {
          name: "Cursor",
          desc: "AI-first code editor built for pair programming.",
          uses: "Refactoring, boilerplate generation, in-context debugging.",
          why: "Aligns with your backend architecture focus.",
          gain: "40%",
        },
        {
          name: "GitHub Copilot",
          desc: "Inline code completion and chat.",
          uses: "Writing test cases, translating code, regex.",
          why: "Industry standard, seamless workflow integration.",
          gain: "25%",
        },
        {
          name: "Claude 3.5 Sonnet",
          desc: "Advanced reasoning model with deep context window.",
          uses: "System design, log analysis, architectural reviews.",
          why: "Exceptional at parsing large architectural codebases.",
          gain: "30%",
        },
      ],
    },
      ...
      tools: [
        {
          ...
          uses: "Drafting technical specs, meeting summaries.",
          why: "Helps translate technical work to business stakeholders.",
          gain: "20%",
        },
        {
          name: "Perplexity",
          desc: "AI-powered search engine.",
          uses: "Researching new libraries, troubleshooting errors.",
          why: "Faster than traditional documentation search.",
          gain: "35%",
        },
        {
          name: "Gamma",
          desc: "AI presentation generator.",
          uses: "Creating architecture slide decks quickly.",
          why: "Elevates your leadership and presentation readiness.",
          gain: "50% (on presentations)",
        },
      ],
    },
    {
      ...
      tools: [
        {
          ...
          uses: "Conceptual architecture diagrams, blog graphics.",
          why: "Adds visual flair to your technical writing.",
          gain: "N/A",
        },
        {
          name: "Canva AI",
          desc: "Accessible design suite with AI tools.",
          uses: "Quick mockups, personal branding.",
          why: "Low barrier to entry for non-designers.",
          gain: "N/A",
        },
      ],
    },
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {cat.tools.map((tool, idx) => (
              ...
              >
                ...
                <p className="text-muted-foreground font-medium text-sm mb-6 flex-1">{tool.desc}</p>
