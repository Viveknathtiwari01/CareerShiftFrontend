...
export function WorkshopHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl hero-ink px-6 py-20 sm:px-10 lg:px-16 text-center shadow-2xl my-6">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/15 via-transparent to-teal/10 opacity-80" />
      ...
      >
        ...
        <motion.h1
          variants={itemVars}
          className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl text-sidebar-foreground"
        >
        ...
        <motion.p
          variants={itemVars}
          className="mt-6 text-lg leading-8 text-sidebar-foreground/80 max-w-2xl mx-auto"
        >
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full w-full sm:w-auto text-base h-12 px-8 group border-sidebar-foreground/30 text-sidebar-foreground hover:text-primary-foreground hover:bg-primary bg-white/5 backdrop-blur-sm"
          >
            Watch Free Preview
