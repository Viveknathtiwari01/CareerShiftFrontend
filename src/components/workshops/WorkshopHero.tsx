  ...
  return (
    <section className="relative overflow-hidden rounded-3xl surface-card px-6 py-20 sm:px-10 lg:px-16 text-center shadow-2xl my-6">
      ...
      >
        ...
        <motion.h1 variants={itemVars} className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl text-white">
        ...
        <motion.p variants={itemVars} className="mt-6 text-lg leading-8 text-white/80 max-w-2xl mx-auto">
          CareerShift has shown you where you are today. Now let's help you become the professional AI will never replace.
        </motion.p>
        
        <motion.div variants={itemVars} className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" className="rounded-full w-full sm:w-auto text-base h-12 px-8 bg-primary text-primary-foreground hover:bg-primary/90">
            Explore Workshop
          </Button>
          <Button variant="outline" size="lg" className="rounded-full w-full sm:w-auto text-base h-12 px-8 group border-primary/50 text-white hover:text-primary-foreground hover:bg-primary bg-white/5 backdrop-blur-sm">
            Watch Free Preview 
