  ...
  return (
    <div className="py-12">
      <div className="mb-10 text-center md:text-left">
        <h2 className="text-3xl font-extrabold tracking-tight text-foreground">Why This Workshop?</h2>
        <p className="mt-3 text-lg text-muted-foreground max-w-2xl">
          We don't teach you how to build AI. We teach you how to use it practically to advance your career.
        </p>
      </div>
      ...
      >
        {features.map((feature, idx) => (
          ...
          >
            ...
            <div className={`relative shrink-0 rounded-xl bg-muted p-3 h-fit border border-border group-hover:bg-background transition-colors`}>
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed group-hover:text-foreground transition-colors">{feature.description}</p>
            </div>
          </motion.div>
        ))}
      </motion.div>
