...
const modules = [
  {
    ...
    description:
      "Demystify AI, learn what it can (and can't) do, and understand its role in the modern workplace.",
    duration: "45 mins",
  },
  {
    title: "Prompt Engineering",
    description:
      "Master the art of talking to AI. Learn frameworks to get the exact output you need, every time.",
    duration: "1.5 hours",
  },
  {
    title: "Daily AI Workflows",
    description:
      "Integrate AI into your daily routines. From email management to meeting summaries and research.",
    duration: "1 hour",
  },
  {
    title: "Using AI at Work",
    description:
      "Role-specific applications. See how marketers, managers, and analysts use AI to multiply their output.",
    duration: "1 hour",
  },
  {
    title: "AI Productivity Tools",
    description:
      "Beyond ChatGPT. Explore the ecosystem of AI tools for presentations, data analysis, and automation.",
    duration: "1 hour",
  },
  {
    title: "Career Growth Strategy",
    description:
      "Position yourself as an AI-augmented professional. Update your resume and LinkedIn to reflect your new skills.",
    duration: "45 mins",
  },
];
    ...
    <div className="py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          A step-by-step curriculum designed to transform how you work, taking you from beginner to
          confident AI user.
        </p>
      </div>
