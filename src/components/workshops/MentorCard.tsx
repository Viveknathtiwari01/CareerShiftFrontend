...
export function MentorCard() {
  return (
    <motion.section
      ...
      className="py-12"
    >
      <div className="hero-ink rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-elevated">
        ...
        <div className="flex flex-col md:flex-row relative z-10 gap-8 items-start">
          <div className="shrink-0 relative">
            <img
              ...
              className="w-32 h-32 md:w-48 md:h-48 rounded-full object-cover border-4 border-sidebar/40 shadow-elevated"
            />
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-bold text-sidebar-foreground mb-2">Nureen Chaudhary</h2>
            <div className="flex flex-wrap gap-x-6 gap-y-2 mb-6 text-sm text-sidebar-foreground/80">
            ...
            <div className="relative mb-6">
              <Quote className="absolute -top-4 -left-4 w-10 h-10 text-sidebar-foreground/10 -z-10" />
              <p className="text-sidebar-foreground text-lg leading-relaxed font-medium italic pl-4 border-l-2 border-primary/40">
            ...
            <div className="rounded-xl border border-sidebar-foreground/15 bg-sidebar/30 backdrop-blur-md p-5">
              <h4 className="text-sidebar-foreground font-semibold flex items-center gap-2 mb-2">
                <Target className="w-4 h-4 text-primary" /> Our Mission
              </h4>
              <p className="text-sidebar-foreground/75 text-sm leading-relaxed">
