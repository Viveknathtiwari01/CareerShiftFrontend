        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full w-full sm:w-auto text-lg h-14 px-8 group border-primary/30 text-base hover:text-primary-foreground hover:bg-primary backdrop-blur-sm font-semibold transition-all"
            >
