...
export function CareerShiftJourney() {
  return (
    <div className="py-6">
      <div className="mb-6">
        <h2 className="text-xl font-bold tracking-tight text-foreground">How CareerShift Helps You</h2>
        <p className="mt-1 text-sm text-muted-foreground">Your step-by-step roadmap to AI fluency.</p>
      </div>
