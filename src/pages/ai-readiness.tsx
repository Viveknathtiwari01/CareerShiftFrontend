...
export default function AIReadiness() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-12 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div>
        <h2 className="mb-3 font-display text-4xl font-bold tracking-tight">AI Readiness Assessment</h2>
        <p className="max-w-6xl text-lg text-muted-foreground">
          CareerShift evaluated your current AI adoption, work patterns, competencies, and career profile to estimate how prepared you are for the evolving AI workplace.
        </p>
      </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              { name: "Cursor", fit: "AI-first code editor", useCase: "Daily coding & refactoring" },
              { name: "GitHub Copilot", fit: "Inline code generation", useCase: "Boilerplate & unit tests" },
              { name: "Claude", fit: "Large context reasoning", useCase: "Log analysis & documentation" },
              { name: "Perplexity", fit: "AI search engine", useCase: "Researching new libraries" }
            ].map(tool => (
              <div key={tool.name} className="rounded-xl border border-border bg-background p-5 shadow-sm">
                <h4 className="font-bold text-foreground mb-3">{tool.name}</h4>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    <div className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1">Why it fits</div>
