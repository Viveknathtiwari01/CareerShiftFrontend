...
import { AuthProvider, AssessmentProvider } from "../store/mock-store";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CareerShift — Bridge Your Career to the AI Future" },
      {
        ...
        content:
          "Turn AI anxiety into AI clarity. Get your personalized AI Career Readiness Report in minutes.",
      },
